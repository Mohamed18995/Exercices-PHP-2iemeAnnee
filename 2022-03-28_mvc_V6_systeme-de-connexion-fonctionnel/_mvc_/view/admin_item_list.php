...
if(is_array($result) && sizeof($result) > 0){
	...
	foreach($result as $r){
		...
		if($is_visible == "1"){
			$li .= "<a href='index.php?p=admin_item&action=deleteActive&id=".$item_id."'>désactiver</a> \n";
			$li .= $item_title;
		}else{
			$li .= "<a href='index.php?p=admin_item&action=deleteActive&id=".$item_id."'>réactiver</a> \n";
			$li .= "<s>".$item_title."</s>";
		}
